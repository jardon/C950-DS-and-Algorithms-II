...
truck1_priority = [13,14,15,16,29,30,31,34,37,40]
truck2_priority = [6,20,25]
truck3_priority = []
truck1_destinations = []
truck2_destinations = []
truck3_destinations = []
truck1_priority_destinations = []
truck2_priority_destinations = []
truck3_priority_destinations = []
truck1_pos = 0
truck2_pos = 0
truck3_pos = 0
...
for index in truck1_packages:
    ...
    if address == address2 and addressId not in truck1_destinations:
        ...
        truck1_priority_destinations.append(addressId)
...
for index in truck2_packages:
    ...
    if address == address2 and addressId not in truck2_destinations:
        ...
        truck2_priority_destinations.append(addressId)
...
for index in truck3_packages:
    ...
    if address == address2 and addressId not in truck3_destinations:
        ...
        truck3_priority_destinations.append(addressId)

while True:
    if len(truck1_priority_destinations) > 0:
        truck1_next = find_closest_destination(truck1_pos, truck1_priority_destinations)
        truck1_pos = truck1_next[0]
        truck1_distance += float(truck1_next[1])
        truck1_destinations.remove(truck1_next[0])
        truck1_priority_destinations.remove(truck1_next[0])
    elif len(truck1_destinations) > 0:
    ...
    if len(truck2_priority_destinations) > 0:
        truck2_next = find_closest_destination(truck2_pos, truck2_priority_destinations)
        truck2_pos = truck2_next[0]
        truck2_distance += float(truck2_next[1])
        truck2_destinations.remove(truck2_next[0])
        truck2_priority_destinations.remove(truck2_next[0])
    elif len(truck2_destinations) > 0:
    ...
    if len(truck3_priority_destinations) > 0:
        truck3_next = find_closest_destination(truck3_pos, truck3_priority_destinations)
        truck3_pos = truck3_next[0]
        truck3_distance += float(truck3_next[1])
        truck3_destinations.remove(truck3_next[0])
        truck3_priority_destinations.remove(truck3_next[0])
    elif len(truck3_destinations) > 0:
